...
CREATE TABLE dim_FilmTitles (
	FilmTitleSK int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_FunFacts (
	FunFactsSK int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_Actors (
	ActorSK int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_Writer (
	WriterSK  int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_Director (
	DirectorSK  int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_Distributor (
	DistributorSK  int NOT NULL IDENTITY(1,1),
...
CREATE TABLE dim_ProductionCompany (
	ProductionCompanySK  int NOT NULL IDENTITY(1,1),
...
CREATE TABLE stg_sf_Film_Locations_tsv (
	sf_film_locations_sk int NOT NULL IDENTITY(1,1),
	title varchar(80) NOT NULL,
	release_year int NULL,
